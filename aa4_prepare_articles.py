...
def prepare_articles():
    ...
    if not PATH_DELTA_TEX.exists():
        ...
        sys.exit(1)
    print(f"# Delta file: ./{PATH_DELTA_TEX}")
    ...
    print(f"# Creating files (merging {PATH_DELTA_TEX} with 05-article.tex)")
    for tex_file in tex_files:
        main_file = str(PATH_DELTA_TEX) # 2025-01-delta.text
        filename = str(tex_file) # 01-art-01.tex
        filename_new = tex_file.name # delta-01-art-01.tex
